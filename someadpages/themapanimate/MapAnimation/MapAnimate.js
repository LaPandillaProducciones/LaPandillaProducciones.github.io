...
lib.ssMetadata = [
		...
		{name:"MapAnimate_atlas_3", frames: [[1302,1594,362,287],[1302,1002,590,590],[0,1002,1300,800],[0,0,2000,1000]]}
];
...
(lib.Symbol_3_Layer_1 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.nubes();
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.9523,1.9523);
...
(lib.Symbol_2_Layer_1 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.nubes();
	this.instance.parent = this;
	this.instance.setTransform(0,0,2.4484,2.4484);
...
(lib.Scene_1_AnimacionPrincipal = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// AnimacionPrincipal
	this.instance = new lib.solido();
	this.instance.parent = this;
	this.instance.setTransform(-355,-36);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.Layer_1.name = "Layer_1";
	this.Layer_1.parent = this;
	this.Layer_1.setTransform(1952.2,976.1,1,1,0,0,0,1952.2,976.1);
	this.Layer_1.depth = 0;
	this.Layer_1.isAttachedToCamera = 0
	this.Layer_1.isAttachedToMask = 0
	this.Layer_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,3904.5,1952.3), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.Layer_1.name = "Layer_1";
	this.Layer_1.parent = this;
	this.Layer_1.setTransform(2448.4,1224.2,1,1,0,0,0,2448.4,1224.2);
	this.Layer_1.depth = 0;
	this.Layer_1.isAttachedToCamera = 0
	this.Layer_1.isAttachedToMask = 0
	this.Layer_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,4896.8,2448.4), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,0,4896.8,2448.4), null);


(lib.Scene_1_Nubes_copy_copy_copy_copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Scene_1_Nubes_copy_copy_copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Scene_1_Nubes_copy_copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Scene_1_Nubes_copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.SymGiroTierraFrame = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(932.05,568.5,1.2491,1.2491,0,0,0,995.6,495.4);
...
p.nominalBounds = new cjs.Rectangle(-919.4,-147,3106,1345.8);
...
(lib.SymGiroTierra = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.SymNubes();
	this.instance_2.parent = this;
	this.instance_2.setTransform(333.85,386.95,1.2491,1.2491,0,0,0,995.9,495.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:1000,regY:500,x:344,y:393.95},0).wait(1).to({x:349.05,y:395.5},0).wait(1).to({x:354.05,y:397},0).wait(1).to({x:359.1,y:398.55},0).wait(1).to({x:364.1,y:400.05},0).wait(1).to({x:369.15,y:401.6},0).wait(1).to({x:374.2,y:403.1},0).wait(1).to({x:379.2,y:404.65},0).wait(1).to({x:384.25,y:406.15},0).wait(1).to({x:389.25,y:407.7},0).wait(1).to({x:394.3,y:409.2},0).wait(1).to({x:399.3,y:410.75},0).wait(1).to({x:404.35,y:412.25},0).wait(1).to({x:409.4,y:413.8},0).wait(1).to({x:414.4,y:415.3},0).wait(1).to({x:419.45,y:416.85},0).wait(1).to({x:424.45,y:418.4},0).wait(1).to({x:429.5,y:419.9},0).wait(1).to({x:434.5,y:421.45},0).wait(1).to({x:439.55,y:422.95},0).wait(1).to({x:444.6,y:424.5},0).wait(1).to({x:449.6,y:426},0).wait(1).to({x:454.65,y:427.55},0).wait(1).to({x:459.65,y:429.05},0).wait(1).to({x:464.7,y:430.6},0).wait(1).to({x:469.75,y:432.1},0).wait(1).to({x:474.75,y:433.65},0).wait(1).to({x:479.8,y:435.15},0).wait(1).to({x:484.8,y:436.7},0).wait(1).to({x:489.85,y:438.2},0).wait(1).to({x:494.85,y:439.75},0).wait(1).to({x:499.9,y:441.3},0).wait(1).to({x:504.95,y:442.8},0).wait(1).to({x:509.95,y:444.35},0).wait(1).to({x:515,y:445.85},0).wait(1).to({x:520,y:447.4},0).wait(1).to({x:525.05,y:448.9},0).wait(1).to({x:530.05,y:450.45},0).wait(1).to({x:535.1,y:451.95},0).wait(1).to({x:540.15,y:453.5},0).wait(1).to({x:545.15,y:455},0).wait(1).to({x:550.2,y:456.55},0).wait(1).to({x:555.2,y:458.05},0).wait(1).to({x:560.25,y:459.6},0).wait(1).to({x:565.25,y:461.1},0).wait(1).to({x:570.3,y:462.65},0).wait(1).to({x:575.35,y:464.15},0).wait(1).to({x:580.35,y:465.7},0).wait(1).to({x:585.4,y:467.25},0).wait(1).to({x:590.4,y:468.75},0).wait(1).to({x:595.45,y:470.3},0).wait(1).to({x:600.45,y:471.8},0).wait(1).to({x:605.5,y:473.35},0).wait(1).to({x:610.55,y:474.85},0).wait(1).to({x:615.55,y:476.4},0).wait(1).to({x:620.6,y:477.9},0).wait(1).to({x:625.6,y:479.45},0).wait(1).to({x:630.65,y:480.95},0).wait(1).to({x:635.7,y:482.5},0).wait(1).to({x:640.7,y:484},0).wait(1).to({x:645.75,y:485.55},0).wait(1).to({x:650.75,y:487.05},0).wait(1).to({x:655.8,y:488.6},0).wait(1).to({x:660.8,y:490.15},0).wait(1).to({x:665.85,y:491.65},0).wait(1).to({x:670.9,y:493.2},0).wait(1).to({x:675.9,y:494.7},0).wait(1).to({x:680.95,y:496.25},0).wait(1).to({x:685.95,y:497.75},0).wait(1).to({x:691,y:499.3},0).wait(1).to({x:696,y:500.8},0).wait(1).to({x:701.05,y:502.35},0).wait(1).to({x:706.1,y:503.85},0).wait(1).to({x:711.1,y:505.4},0).wait(1).to({x:716.15,y:506.9},0).wait(1).to({x:721.15,y:508.45},0).wait(1).to({x:726.2,y:509.95},0).wait(1).to({x:731.2,y:511.5},0).wait(1).to({x:736.25,y:513},0).wait(1).to({x:741.3,y:514.55},0).wait(1).to({x:746.3,y:516.1},0).wait(1).to({x:751.35,y:517.6},0).wait(1).to({x:756.35,y:519.15},0).wait(1).to({x:761.4,y:520.65},0).wait(1).to({x:766.4,y:522.2},0).wait(1).to({x:771.45,y:523.7},0).wait(1).to({x:776.5,y:525.25},0).wait(1).to({x:781.5,y:526.75},0).wait(1).to({x:786.55,y:528.3},0).wait(1).to({x:791.55,y:529.8},0).wait(1).to({x:796.6,y:531.35},0).wait(1).to({x:801.65,y:532.85},0).wait(1).to({x:806.65,y:534.4},0).wait(1).to({x:811.7,y:535.9},0).wait(1).to({x:816.7,y:537.45},0).wait(1).to({x:821.75,y:539},0).wait(1).to({x:826.75,y:540.5},0).wait(1).to({x:831.8,y:542.05},0).wait(1).to({x:836.85,y:543.55},0).wait(1).to({x:841.85,y:545.1},0).wait(1).to({x:846.9,y:546.6},0).wait(1).to({x:851.9,y:548.15},0).wait(1).to({x:856.95,y:549.65},0).wait(1).to({x:861.95,y:551.2},0).wait(1).to({x:867,y:552.7},0).wait(1).to({x:872.05,y:554.25},0).wait(1).to({x:877.05,y:555.75},0).wait(1).to({x:882.1,y:557.3},0).wait(1).to({x:887.1,y:558.8},0).wait(1).to({x:892.15,y:560.35},0).wait(1).to({x:897.15,y:561.85},0).wait(1).to({x:902.2,y:563.4},0).wait(1).to({x:907.25,y:564.95},0).wait(1).to({x:912.25,y:566.45},0).wait(1).to({x:917.3,y:568},0).wait(1).to({x:922.3,y:569.5},0).wait(1).to({x:927.35,y:571.05},0).wait(1).to({x:932.35,y:572.55},0).wait(1).to({x:937.4,y:574.1},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-1123.5,-232.1,3309.9,1430.8);
...
(lib.SymElSimbolo_FrameCentroAmerica = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(120).to({regX:673.3,regY:314.2,scaleX:1.1402,scaleY:1.1402,x:590.65,y:305.05},0).wait(1).to({regX:633.6,regY:525.9,scaleX:1.3769,scaleY:1.3769,x:530.75,y:593.05},0).wait(1).to({scaleX:1.6136,scaleY:1.6136,x:516.1,y:639.6},0).wait(1).to({scaleX:1.8502,scaleY:1.8502,x:501.45,y:686.25},0).wait(1).to({scaleX:2.0869,scaleY:2.0869,x:486.75,y:732.8},0).wait(1).to({scaleX:2.3236,scaleY:2.3236,x:472.1,y:779.35},0).wait(1).to({scaleX:2.5602,scaleY:2.5602,x:457.45,y:825.95},0).wait(1).to({scaleX:2.7969,scaleY:2.7969,x:442.8,y:872.55},0).wait(1).to({scaleX:3.0336,scaleY:3.0336,x:428.1,y:919.1},0).wait(1).to({scaleX:3.2702,scaleY:3.2702,x:413.45,y:965.7},0).wait(1).to({scaleX:3.5069,scaleY:3.5069,x:398.8,y:1012.25},0).wait(1).to({scaleX:3.7436,scaleY:3.7436,x:384.15,y:1058.85},0).wait(1).to({scaleX:3.9802,scaleY:3.9802,x:369.45,y:1105.45},0).wait(1).to({scaleX:4.2169,scaleY:4.2169,x:354.8,y:1152},0).wait(1).to({scaleX:4.4536,scaleY:4.4536,x:340.15,y:1198.55},0).wait(1).to({scaleX:4.6902,scaleY:4.6902,x:325.45,y:1245.2},0).wait(1).to({scaleX:4.9269,scaleY:4.9269,x:310.8,y:1291.75},0).wait(1).to({scaleX:5.1635,scaleY:5.1635,x:296.15,y:1338.3},0).wait(1).to({scaleX:5.4002,scaleY:5.4002,x:281.5,y:1384.9},0).wait(1).to({scaleX:5.6369,scaleY:5.6369,x:266.8,y:1431.5},0).wait(1).to({scaleX:5.8735,scaleY:5.8735,x:252.15,y:1478.05},0).wait(1).to({scaleX:6.1102,scaleY:6.1102,x:237.5,y:1524.65},0).wait(1).to({scaleX:6.3469,scaleY:6.3469,x:222.85,y:1571.2},0).wait(1).to({scaleX:6.5835,scaleY:6.5835,x:208.2,y:1617.8},0).wait(1).to({scaleX:6.8202,scaleY:6.8202,x:193.55,y:1664.4},0).wait(1).to({scaleX:7.0569,scaleY:7.0569,x:178.9,y:1710.95},0).wait(1).to({scaleX:7.2935,scaleY:7.2935,x:164.25,y:1757.5},0).wait(1).to({scaleX:7.5302,scaleY:7.5302,x:149.55,y:1804.15},0).wait(1).to({scaleX:7.7669,scaleY:7.7669,x:134.9,y:1850.7},0).wait(1).to({scaleX:8.0035,scaleY:8.0035,x:120.25,y:1897.25},0).wait(1).to({scaleX:8.2402,scaleY:8.2402,x:105.6,y:1943.85},0).wait(1).to({scaleX:8.4769,scaleY:8.4769,x:90.9,y:1990.45},0).wait(1).to({scaleX:8.7135,scaleY:8.7135,x:76.25,y:2037},0).wait(1).to({scaleX:8.9502,scaleY:8.9502,x:61.6,y:2083.6},0).wait(1).to({scaleX:9.1869,scaleY:9.1869,x:46.9,y:2130.15},0).wait(1).to({scaleX:9.4235,scaleY:9.4235,x:32.25,y:2176.75},0).wait(1).to({scaleX:9.6602,scaleY:9.6602,x:17.6,y:2223.35},0).wait(1).to({scaleX:9.8969,scaleY:9.8969,x:2.95,y:2269.9},0).wait(1).to({scaleX:10.1335,scaleY:10.1335,x:-11.75,y:2316.45},0).wait(1).to({scaleX:10.3702,scaleY:10.3702,x:-26.4,y:2363.1},0).wait(1).to({scaleX:10.6069,scaleY:10.6069,x:-41.05,y:2409.65},0).wait(1).to({scaleX:10.8435,scaleY:10.8435,x:-55.7,y:2456.2},0).wait(1).to({scaleX:11.0802,scaleY:11.0802,x:-70.4,y:2502.8},0).wait(1).to({scaleX:11.3169,scaleY:11.3169,x:-85.05,y:2549.4},0).wait(1).to({scaleX:11.5535,scaleY:11.5535,x:-99.7,y:2596},0).wait(1).to({scaleX:11.7902,scaleY:11.7902,x:-114.35,y:2642.55},0).wait(1).to({scaleX:12.0269,scaleY:12.0269,x:-129.05,y:2689.1},0).wait(1).to({scaleX:12.2635,scaleY:12.2635,x:-143.7,y:2735.75},0).wait(1).to({scaleX:12.5002,scaleY:12.5002,x:-158.35,y:2782.3},0).wait(1).to({scaleX:12.7369,scaleY:12.7369,x:-173.05,y:2828.85},0).wait(1).to({scaleX:12.9735,scaleY:12.9735,x:-187.7,y:2875.45},0).wait(1).to({scaleX:13.2102,scaleY:13.2102,x:-202.35,y:2922.05},0).wait(1).to({scaleX:13.4469,scaleY:13.4469,x:-217,y:2968.6},0).wait(1).to({scaleX:13.6835,scaleY:13.6835,x:-231.7,y:3015.2},0).wait(1).to({scaleX:13.9202,scaleY:13.9202,x:-246.3,y:3061.75},0).wait(1).to({scaleX:14.1568,scaleY:14.1568,x:-260.95,y:3108.35},0).wait(1).to({scaleX:14.3935,scaleY:14.3935,x:-275.6,y:3154.95},0).wait(1).to({scaleX:14.6302,scaleY:14.6302,x:-290.3,y:3201.5},0).wait(1).to({scaleX:14.8668,scaleY:14.8668,x:-304.95,y:3248.05},0).wait(1).to({scaleX:15.1035,scaleY:15.1035,x:-319.6,y:3294.7},0).wait(1).to({scaleX:15.3402,scaleY:15.3402,x:-334.25,y:3341.25},0).wait(1).to({scaleX:15.5768,scaleY:15.5768,x:-348.95,y:3387.8},0).wait(1).to({scaleX:15.8135,scaleY:15.8135,x:-363.6,y:3434.4},0).wait(1).to({scaleX:16.0502,scaleY:16.0502,x:-378.25,y:3481},0).wait(1).to({scaleX:16.2868,scaleY:16.2868,x:-392.95,y:3527.55},0).wait(1).to({scaleX:16.5235,scaleY:16.5235,x:-407.6,y:3574.15},0).wait(1).to({scaleX:16.7602,scaleY:16.7602,x:-422.25,y:3620.7},0).wait(1).to({scaleX:16.9968,scaleY:16.9968,x:-436.9,y:3667.3},0).wait(1).to({scaleX:17.2335,scaleY:17.2335,x:-451.6,y:3713.9},0).wait(1).to({scaleX:17.4702,scaleY:17.4702,x:-466.25,y:3760.45},0).wait(1).to({scaleX:17.7068,scaleY:17.7068,x:-480.9,y:3807},0).wait(1).to({scaleX:17.9435,scaleY:17.9435,x:-495.55,y:3853.65},0).wait(1));
...
(lib.SymElSimbolo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.zoomTierraMv).wait(1).to({regX:429.7,regY:498.5,x:429.7,y:498.5},0).wait(118).to({_off:true},1).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.FrameCentroAmerica).wait(121).to({regX:-495.5,regY:3853.2,x:-495.5,y:3853.2},0).wait(70).to({_off:true},1).wait(24));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28361.2,-8220.6,55731.8,24147.1);


(lib.Scene_1_zoomTierraMv = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Scene_1_FrameCentroAmerica = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.MapAnimate = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.addChild(new lib.SymGiroTierraCompleto());
	}
	...
	// Nubes_copy_copy_copy_copy_obj_
	this.Nubes_copy_copy_copy_copy = new lib.Scene_1_Nubes_copy_copy_copy_copy();
	this.Nubes_copy_copy_copy_copy.name = "Nubes_copy_copy_copy_copy";
	this.Nubes_copy_copy_copy_copy.parent = this;
	this.Nubes_copy_copy_copy_copy.depth = 0;
	this.Nubes_copy_copy_copy_copy.isAttachedToCamera = 0
	...
	this.timeline.addTween(cjs.Tween.get(this.Nubes_copy_copy_copy_copy).wait(139).to({regX:-899.8,regY:-275,x:-899.8,y:-275},0).wait(76).to({_off:true},1).wait(145));

	// Nubes_copy_copy_copy_obj_
	this.Nubes_copy_copy_copy = new lib.Scene_1_Nubes_copy_copy_copy();
	this.Nubes_copy_copy_copy.name = "Nubes_copy_copy_copy";
	this.Nubes_copy_copy_copy.parent = this;
	this.Nubes_copy_copy_copy.depth = 0;
	this.Nubes_copy_copy_copy.isAttachedToCamera = 0
	...
	this.timeline.addTween(cjs.Tween.get(this.Nubes_copy_copy_copy).wait(134).to({regX:-901.9,regY:146.2,x:-901.9,y:146.2},0).wait(75).to({_off:true},1).wait(151));

	// Nubes_copy_copy_obj_
	this.Nubes_copy_copy = new lib.Scene_1_Nubes_copy_copy();
	this.Nubes_copy_copy.name = "Nubes_copy_copy";
	this.Nubes_copy_copy.parent = this;
	this.Nubes_copy_copy.depth = 0;
	this.Nubes_copy_copy.isAttachedToCamera = 0
	...
	this.timeline.addTween(cjs.Tween.get(this.Nubes_copy_copy).wait(126).to({regX:577.4,regY:306.2,x:577.4,y:306.2},0).wait(85).to({_off:true},1).wait(149));

	// Nubes_copy_obj_
	this.Nubes_copy = new lib.Scene_1_Nubes_copy();
	this.Nubes_copy.name = "Nubes_copy";
	this.Nubes_copy.parent = this;
	this.Nubes_copy.depth = 0;
	this.Nubes_copy.isAttachedToCamera = 0
	...
	this.timeline.addTween(cjs.Tween.get(this.Nubes_copy).wait(126).to({regX:1047.2,regY:1708.9,x:1047.2,y:1708.9},0).wait(87).to({_off:true},1).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.Nubes).wait(126).to({regX:795.3,regY:628.9,x:795.3,y:628.9},0).wait(89).to({_off:true},1).wait(145));

	// zoomTierraMv_obj_
	this.zoomTierraMv = new lib.Scene_1_zoomTierraMv();
	this.zoomTierraMv.name = "zoomTierraMv";
	this.zoomTierraMv.parent = this;
	this.zoomTierraMv.setTransform(342.6,369.9,1,1,0,0,0,342.6,369.9);
	this.zoomTierraMv.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.zoomTierraMv).wait(1).to({regX:429.7,regY:498.5,x:429.7,y:498.5},0).wait(118).to({_off:true},1).wait(241));

	// FrameCentroAmerica_obj_
	this.FrameCentroAmerica = new lib.Scene_1_FrameCentroAmerica();
	this.FrameCentroAmerica.name = "FrameCentroAmerica";
	this.FrameCentroAmerica.parent = this;
	this.FrameCentroAmerica.setTransform(557.3,479.2,1,1,0,0,0,557.3,479.2);
	this.FrameCentroAmerica.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.FrameCentroAmerica).wait(121).to({regX:-494.7,regY:3853.2,x:-494.7,y:3853.2},0).wait(70).to({_off:true},1).wait(169));

	// AnimacionPrincipal_obj_
	this.AnimacionPrincipal = new lib.Scene_1_AnimacionPrincipal();
	this.AnimacionPrincipal.name = "AnimacionPrincipal";
	this.AnimacionPrincipal.parent = this;
	this.AnimacionPrincipal.setTransform(645,464,1,1,0,0,0,645,464);
	this.AnimacionPrincipal.depth = 0;
	this.AnimacionPrincipal.isAttachedToCamera = 0
	this.AnimacionPrincipal.isAttachedToMask = 0
	this.AnimacionPrincipal.layerDepth = 0
	this.AnimacionPrincipal.layerIndex = 7
	this.AnimacionPrincipal.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.AnimacionPrincipal).wait(361));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-27720.5,-7860.6,55091.9,23787.1);
// library properties:
lib.properties = {
